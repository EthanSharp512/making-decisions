...
if(temperature >= 80 && rain === true) {
  ...
  console.log("One should wear a t-shirt and pants.");
...
if(changeMyMind === true) {
  ...
  changeMyMind = false;
  console.log(`changeMyMind has been changed to ${changeMyMind}.`);
...
////////// PROBLEM 10 //////////
// Using the "not" operator (!), change the current value of changeMyMind to true (it should currently be set to false due to 
// the if-else statement in Problem 9). After you change the value of changeMyMind, console.log it's new value (it should now read true).
...
let z = 5;
// Create a while loop that continues to run while z is greater than 0. Within the while loop, log a countdown from the 
// value of z to 1. Once you have logged the countdown, make sure you decrement z by 1. If your code is running properly, 
